...
export default function PaymentFunction() {
  ...
  const Pay = () => {
    //   const pathchange = () =>{
    //     if(path=='user'){
    //         setPathame('/user/purchases')
    //     }
    //     else if(path=='builder'){
    //         setPathame('/user/purchases')
    //     }
    //     else{
    //       setPathame('/architect/purchases')
    //     }
    // }
    var dat = {
      email: email,
  ...
  return (
    <div className="paymentcontainer">
      ...
      <Box sx={{ '& > :not(style)': { m: 1 } }}>
        <Fab color="primary" aria-label="add" variant="extended" onClick={pathchange}>
          <HomeIcon />
          Home
        </Fab>
      </Box>
