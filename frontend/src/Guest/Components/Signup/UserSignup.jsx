...
const UserSignup = () => {
  ...
  const inputData = (e) => {
    formData.append("user_name", fname + " " + lname);
    formData.append("user_email", email);
    formData.append("user_contact", number);
    ...
    axios
      .post("http://localhost:4000/UserReg", formData, config)
      .then((response) => {
  ...
  return (
    <div className="form mtt_30">
      <div className="r-header">
        <a href="/signup/BuilderReg">
          <button className="button n-button">Builder Sign Up</button>
        </a>
      ...
      <div className="r-title title-bar mtt_25">
        <span>
          <PersonAddAlt1Icon className="title-icon" />
        </span>
        <span className="r-sub">Create User Account</span>
      </div>
