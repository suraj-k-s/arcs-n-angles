...
const ArchitectSignup = () => {
  ...
  const inputData = (e) => {
    formData.append("architect_name", fname + " " + lname);
    formData.append("architect_email", email);
    formData.append("architect_contact", number);
    formData.append("architect_address", address);
    formData.append("place_id", selplaces);
    formData.append("architect_photo", file);
    formData.append("architect_proof", pfile);
    formData.append("architect_gender", gender);
    formData.append("architect_password", password);
    ...
    axios
      .post("http://localhost:4000/ArchitectReg", formData, config)
      .then((response) => {
  ...
  return (
    <div className="form mtt_30">
      <div className="r-header">
        ...
        <NavLink to="/signup/BuilderReg">
          <button className="button new-reg-btn">Builder Sign Up</button>
        </NavLink>
      </div>
      <div className="r-title title-bar mtt_25">
        <span>
          <EngineeringIcon className="title-icon" />
        </span>
        <span className="r-sub">Create Architect Account</span>
      </div>
