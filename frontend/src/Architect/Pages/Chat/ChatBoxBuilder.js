...
const ChatBoxbuilder = () => {
  ...
  const fetchChat = () => {
    console.log("hii");
    axios.get("http://localhost:4000/builderarchchat/" + bid.bid + "&" + sessionStorage.getItem("arid"))
      .then((response) => {
  ...
  const archbuilderchat = () => {
    ...
    axios.post("http://localhost:4000/archbuilderchat/", msg).then((response) => {
      fetchChat();
      setTxtmsg("");
  ...
  const chatattachmentarchbuilder = () => {
    ...
    axios.post("http://localhost:4000/chatattachmentarchbuilder/", formData, config).then((response) => {
    ...
    <>
      <Box className='chat_container'>
        <Box className='chat_bottom'>
          ...
          <Box>
            <Button className='send_btn' onClick={archbuilderchat}>
              <SendIcon />
            </Button>
          </Box>
        </Box>
        ...
        <Fade in={open}>
          <Box className='chat_upload'>
            ...
            <Box className='btnact'>
              ...
              <Button onClick={chatattachmentarchbuilder} className='uploadbtn'>Send</Button>
            </Box>
          </Box>
        </Fade>
      </Modal>
